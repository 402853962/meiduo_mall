...
SECRET_KEY = ')+7ju1j892bh=@5e-p5=7_^*eixltz@!7@i82avhi3cvomw79_'
...
CRONJOBS = [
    # 每1分钟生成一次首页静态文件
    ('*/1 * * * *', 'apps.contents.crons.generic_index_html', '>> ' + os.path.join(BASE_DIR, 'logs/crontab.log'))
]
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.112.146:9200/', # Elasticsearch服务器ip地址，端口号固定为9200
